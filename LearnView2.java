 ...
 * The second view for teaching proper typing technique
 */

import javax.swing.*;
import java.awt.*;

public class LearnView2 extends LearnPanel2
{
	//instance variables
	...
	//constructor
	public LearnView2(FrameModel model, JFrame frame)
	{
		super();
	...
	{
		FrameSwitchController controllerOne = new FrameSwitchController(this.next,this.frameModel,"Learn3");
